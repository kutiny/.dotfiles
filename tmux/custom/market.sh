...
fetch_data() {
    ...
    local buy_price=$(echo $html_response | \
        ...
        "/html/body/div[5]/div[3]/div[1]/div[1]/div[2]/section/div/div/div[2]/div[1]/div/div[2]/div[3]/div/div[1]/div[2]/text()" - |\
        tail -1 | tr -d '$' | sed 's/\..*//g')
    local sell_price=$(echo $html_response | \
        xmllint --nowarning --html --xpath \
        "/html/body/div[5]/div[3]/div[1]/div[1]/div[2]/section/div/div/div[2]/div[1]/div/div[2]/div[3]/div/div[3]/div[1]/div[2]/text()" - |\
        tail -1 | tr -d '$' | sed 's/\..*//g')
    local change=$(echo $html_response |\
        xmllint --nowarning --html --xpath \
        "/html/body/div[5]/div[3]/div[1]/div[1]/div[2]/section/div/div/div[2]/div[1]/div/div[2]/div[3]/div/div[3]/div[2]/div/text()" - |\
        tail -1)
