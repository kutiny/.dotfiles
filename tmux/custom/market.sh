...
show_market() {
    ...
    local buy_price=$(echo $html_response | \
        ...
        "/html/body/div[3]/div[2]/div[1]/div[1]/div[2]/section/div/div/div/div[1]/div/div[2]/div[3]/div/div[1]/div[2]/text()" - |\
        tail -1 | tr -d '$' | sed 's/\..*//g')
    local sell_price=$(echo $html_response | \
        xmllint --nowarning --html --xpath \
        "/html/body/div[3]/div[2]/div[1]/div[1]/div[2]/section/div/div/div/div[1]/div/div[2]/div[3]/div/div[2]/div[2]/text()" - |\
        tail -1 | tr -d '$' | sed 's/\..*//g')
